TXT = {
    ...
    "projects": [
        {
            ...
            "role": "Liderul echipei, Frontend/Backend dezvoltator",
            ...
            "responsibilities": [
                ...
                "Implementarea unei setări de temă întunecată (frontend), inclusiv modele de colorare a temelor și componentelor",
                "Ajutând colegii de echipă cu codul lor, uneori refactorând părți inconsistente ale aplicației"
            ]
        },
        {
            "title": "Site-ul de instrumente virtuale",
            "tech_stack": [
                "Javascript",
                "CSS"
            ],
        ...
        {
            "title": "...mai multe se pot vedea aici",
            "tech_stack": [
                "C++"
            ],
    ...
    "work exp": [
        ...
        },
        {
            ...
            "direction": "Om bun la toate",
            "time_period": "Aprilie-Mai 2018",
            "responsibility_list": []
        }
    ],
    "education": [
    ...
    "soft skills": [
        ...
        "Responsabil",
        "Preparativ",
        "Incorporarea AI în ciclul de lucru"
    ],
    "lang skills": [
        "Engleză <a href='img/StatementOfResult.pdf'>B2</a>",
        "Ucraineană gratuită",
        "Rusa Native",
        "Romana pre-intermediar"
    ]
}